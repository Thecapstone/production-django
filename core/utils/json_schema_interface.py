from typing import Literal, Optional, List, Any, Dict, TypedDict, Union
...
class LicenseSchema(TypedDict):
    name: Optional[str]
    identifier: Optional[str]
    url: Optional[str]


class InfoSchema(TypedDict):
    title: str
...
class ExternalDocsSchema(TypedDict):
    description: Optional[str]
    url: Optional[str]


class ServerVariableSchema(TypedDict):
    enum: List[str]
    default: Optional[str]
    description: Optional[str]


class ServerPortSchema(TypedDict):
    enum: List[str]
    description: Optional[str]


class ServerEnumDefaultStyleBaseSchema(TypedDict):
    enum: List[str]
    default: Optional[str]
...
class ParamterSchemaScheme(TypedDict):
...
class BaseExampleSchema(TypedDict):
...
class BoardSecuritySchema(TypedDict):
    security: List[
...
class MediaTypeColorEncoding(TypedDict):
    style: Literal[
        "form",
        "label",
        "simple",
...
class MediaTypeEncoding(TypedDict):
    color: MediaTypeColorEncoding


class MediaTypeSchema(TypedDict):
    schema: (
        "SingleSchema"
...
class ParamtersSchema(TypedDict):
    name: str
...
class RequestBodySchema(TypedDict):
    content: Dict[
        str,
        Dict[
            Literal[
...
class BaseOperationSchema(TypedDict):
    tags: List[str] | None
    summary: Optional[str]
    description: Optional[str]
    operationId: str
...
class SchemaType(TypedDict):
    ...
    class Null(TypedDict):
        type: Literal["null"]


class SingleSchema(TypedDict):
    title: Optional[str]
    description: Optional[str]
    type: Literal["object"]
    properties: (
...
class ComponentsSchema(TypedDict):
...
class FlowsScopeType(TypedDict):
    read: Optional[str]
    write: Optional[str]


class FlowsType(TypedDict):
...
class SecuritySchema(TypedDict):
...
class OpenAPISpecTypedDict(TypedDict):
    openapi: str
    info: InfoSchema
